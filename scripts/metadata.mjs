export function deploymentMetadata(siteUrl) {
  ...
  const schema=JSON.stringify({'@context':'https://schema.org','@type':'WebApplication',name:'Deface — Face & Voice Anonymizer',url:site.href,applicationCategory:'MultimediaApplication',operatingSystem:'Web browser',description:'Mask faces and disguise voices in photos and videos, locally in your browser.'}).replaceAll('<','\\u003c');
